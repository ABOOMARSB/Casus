...
final class Version20211108100716 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE company (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(75) NOT NULL, street LONGTEXT NOT NULL, zip VARCHAR(6) NOT NULL, latitude NUMERIC(20, 16) NOT NULL, longitude NUMERIC(20, 16) NOT NULL,  LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE deal (id INT AUTO_INCREMENT NOT NULL, company_id INT NOT NULL, deal_unique LONGTEXT NOT NULL, title VARCHAR(255) NOT NULL, slug LONGTEXT NOT NULL, img VARCHAR(255) NOT NULL, sold INT NOT NULL, new_price NUMERIC(7, 2) NOT NULL, from_price NUMERIC(7, 2) NOT NULL, is_for_sale TINYINT(1) NOT NULL, is_new_today TINYINT(1) NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_E3FEC11638B53C32 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
