...
class __TwigTemplate_4518ad831608225b3a1608abe309c4679b79ab70372a6f85c4be39792d43de33 extends Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["deal"]) {
            ...
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["deal"], "getIsForSale", [], "any", false, false, false, 8), true))) {
                ...
                if (twig_get_attribute($this->env, $this->source, $context["deal"], "shouldShowDiscount", [], "any", false, false, false, 12)) {
                    ...
                    // line 15
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["deal"], "getPercentageDiscount", [], "any", false, false, false, 15), "html", null, true);
                    echo "%</div>
                                        </span>
                                    </div>
                                ";
                ...
                echo "\"/>
                                ";
                // line 20
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["deal"], "divIsNew", [], "any", false, false, false, 20), "html", null, true);
                echo "
                            </div>
                            <div class=\"title\">";
                // line 22
                ...
                echo "</div>
                            <div class=\"from\"> &euro; ";
                // line 24
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["deal"], "getFromPrice", [], "any", false, false, false, 24), "html", null, true);
                echo "</div>
                            <div class=\"price\">";
                // line 25
    ...
    {
        return array (  151 => 30,  145 => 29,  138 => 25,  134 => 24,  130 => 23,  126 => 22,  121 => 20,  116 => 19,  109 => 15,  105 => 13,  103 => 12,  98 => 9,  95 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
                            ...
                            <div class=\"img\" >
                                {% if deal.shouldShowDiscount %}
                                    <div class=\"red-ribbon\">
                                        <span>
                                            <div class=\"discount_amount\">{{ deal.getPercentageDiscount }}%</div>
                                        </span>
                                    </div>
                                {% endif %}
                                <img src=\"{{ deal.getFullImg }}\"/>
                                {{ deal.divIsNew }}
                            </div>
                            <div class=\"title\">{{ deal.getTitle }}</div>
                            <div class=\"sold\">{{ deal.getSold }}</div>
                            <div class=\"from\"> &euro; {{ deal.getFromPrice }}</div>
